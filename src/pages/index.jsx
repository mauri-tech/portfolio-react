...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/file/d/16C-1SmpqaWiozSt92V8QMz_QZRfJIRbq/view?usp=sharing" variant="secondary" className="group mt-6 w-full">
        Download CV
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          Portfolio | Mauricio Treviño 
        </title>
        <meta
          name="description"
          content="I am a highly motivated and creative professional with a blend of product management and sales expertise. I have a meticulous eye for detail and a passion for interface design, taking pleasure in creating both functional and beautiful products. 

          I am eager to pivot to web development and bring my problem-solving skills to the table."
        />
      </Head>
